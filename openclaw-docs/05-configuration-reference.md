...
- [Configuration Reference](https://docs.openclaw.ai/gateway/configuration-reference#configuration-reference)
- [Channels](https://docs.openclaw.ai/gateway/configuration-reference#channels)
- [DM and group access](https://docs.openclaw.ai/gateway/configuration-reference#dm-and-group-access)
- [Channel model overrides](https://docs.openclaw.ai/gateway/configuration-reference#channel-model-overrides)
- [Channel defaults and heartbeat](https://docs.openclaw.ai/gateway/configuration-reference#channel-defaults-and-heartbeat)
- [WhatsApp](https://docs.openclaw.ai/gateway/configuration-reference#whatsapp)
- [Telegram](https://docs.openclaw.ai/gateway/configuration-reference#telegram)
- [Discord](https://docs.openclaw.ai/gateway/configuration-reference#discord)
- [Google Chat](https://docs.openclaw.ai/gateway/configuration-reference#google-chat)
- [Slack](https://docs.openclaw.ai/gateway/configuration-reference#slack)
- [Mattermost](https://docs.openclaw.ai/gateway/configuration-reference#mattermost)
- [Signal](https://docs.openclaw.ai/gateway/configuration-reference#signal)
- [BlueBubbles](https://docs.openclaw.ai/gateway/configuration-reference#bluebubbles)
- [iMessage](https://docs.openclaw.ai/gateway/configuration-reference#imessage)
- [Microsoft Teams](https://docs.openclaw.ai/gateway/configuration-reference#microsoft-teams)
- [IRC](https://docs.openclaw.ai/gateway/configuration-reference#irc)
- [Multi-account (all channels)](https://docs.openclaw.ai/gateway/configuration-reference#multi-account-all-channels)
- [Other extension channels](https://docs.openclaw.ai/gateway/configuration-reference#other-extension-channels)
- [Group chat mention gating](https://docs.openclaw.ai/gateway/configuration-reference#group-chat-mention-gating)
- [DM history limits](https://docs.openclaw.ai/gateway/configuration-reference#dm-history-limits)
- [Self-chat mode](https://docs.openclaw.ai/gateway/configuration-reference#self-chat-mode)
- [Commands (chat command handling)](https://docs.openclaw.ai/gateway/configuration-reference#commands-chat-command-handling)
- [Agent defaults](https://docs.openclaw.ai/gateway/configuration-reference#agent-defaults)
- [agents.defaults.workspace](https://docs.openclaw.ai/gateway/configuration-reference#agents-defaults-workspace)
- [agents.defaults.repoRoot](https://docs.openclaw.ai/gateway/configuration-reference#agents-defaults-reporoot)
- [agents.defaults.skipBootstrap](https://docs.openclaw.ai/gateway/configuration-reference#agents-defaults-skipbootstrap)
- [agents.defaults.bootstrapMaxChars](https://docs.openclaw.ai/gateway/configuration-reference#agents-defaults-bootstrapmaxchars)
- [agents.defaults.bootstrapTotalMaxChars](https://docs.openclaw.ai/gateway/configuration-reference#agents-defaults-bootstraptotalmaxchars)
- [agents.defaults.bootstrapPromptTruncationWarning](https://docs.openclaw.ai/gateway/configuration-reference#agents-defaults-bootstrapprompttruncationwarning)
- [agents.defaults.imageMaxDimensionPx](https://docs.openclaw.ai/gateway/configuration-reference#agents-defaults-imagemaxdimensionpx)
- [agents.defaults.userTimezone](https://docs.openclaw.ai/gateway/configuration-reference#agents-defaults-usertimezone)
- [agents.defaults.timeFormat](https://docs.openclaw.ai/gateway/configuration-reference#agents-defaults-timeformat)
- [agents.defaults.model](https://docs.openclaw.ai/gateway/configuration-reference#agents-defaults-model)
- [agents.defaults.cliBackends](https://docs.openclaw.ai/gateway/configuration-reference#agents-defaults-clibackends)
- [agents.defaults.heartbeat](https://docs.openclaw.ai/gateway/configuration-reference#agents-defaults-heartbeat)
- [agents.defaults.compaction](https://docs.openclaw.ai/gateway/configuration-reference#agents-defaults-compaction)
- [agents.defaults.contextPruning](https://docs.openclaw.ai/gateway/configuration-reference#agents-defaults-contextpruning)
- [Block streaming](https://docs.openclaw.ai/gateway/configuration-reference#block-streaming)
- [Typing indicators](https://docs.openclaw.ai/gateway/configuration-reference#typing-indicators)
- [agents.defaults.sandbox](https://docs.openclaw.ai/gateway/configuration-reference#agents-defaults-sandbox)
- [agents.list (per-agent overrides)](https://docs.openclaw.ai/gateway/configuration-reference#agents-list-per-agent-overrides)
- [Multi-agent routing](https://docs.openclaw.ai/gateway/configuration-reference#multi-agent-routing)
- [Binding match fields](https://docs.openclaw.ai/gateway/configuration-reference#binding-match-fields)
- [Per-agent access profiles](https://docs.openclaw.ai/gateway/configuration-reference#per-agent-access-profiles)
- [Session](https://docs.openclaw.ai/gateway/configuration-reference#session)
- [Messages](https://docs.openclaw.ai/gateway/configuration-reference#messages)
- [Response prefix](https://docs.openclaw.ai/gateway/configuration-reference#response-prefix)
- [Ack reaction](https://docs.openclaw.ai/gateway/configuration-reference#ack-reaction)
- [Inbound debounce](https://docs.openclaw.ai/gateway/configuration-reference#inbound-debounce)
- [TTS (text-to-speech)](https://docs.openclaw.ai/gateway/configuration-reference#tts-text-to-speech)
- [Talk](https://docs.openclaw.ai/gateway/configuration-reference#talk)
- [Tools](https://docs.openclaw.ai/gateway/configuration-reference#tools)
- [Tool profiles](https://docs.openclaw.ai/gateway/configuration-reference#tool-profiles)
- [Tool groups](https://docs.openclaw.ai/gateway/configuration-reference#tool-groups)
- [tools.allow / tools.deny](https://docs.openclaw.ai/gateway/configuration-reference#tools-allow-%2F-tools-deny)
- [tools.byProvider](https://docs.openclaw.ai/gateway/configuration-reference#tools-byprovider)
- [tools.elevated](https://docs.openclaw.ai/gateway/configuration-reference#tools-elevated)
- [tools.exec](https://docs.openclaw.ai/gateway/configuration-reference#tools-exec)
- [tools.loopDetection](https://docs.openclaw.ai/gateway/configuration-reference#tools-loopdetection)
- [tools.web](https://docs.openclaw.ai/gateway/configuration-reference#tools-web)
- [tools.media](https://docs.openclaw.ai/gateway/configuration-reference#tools-media)
- [tools.agentToAgent](https://docs.openclaw.ai/gateway/configuration-reference#tools-agenttoagent)
- [tools.sessions](https://docs.openclaw.ai/gateway/configuration-reference#tools-sessions)
- [tools.sessions\_spawn](https://docs.openclaw.ai/gateway/configuration-reference#tools-sessions_spawn)
- [tools.subagents](https://docs.openclaw.ai/gateway/configuration-reference#tools-subagents)
- [Custom providers and base URLs](https://docs.openclaw.ai/gateway/configuration-reference#custom-providers-and-base-urls)
- [Provider field details](https://docs.openclaw.ai/gateway/configuration-reference#provider-field-details)
- [Provider examples](https://docs.openclaw.ai/gateway/configuration-reference#provider-examples)
...
# [​](https://docs.openclaw.ai/gateway/configuration-reference\#configuration-reference)  Configuration Reference
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#dm-and-group-access)  DM and group access
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#channel-model-overrides)  Channel model overrides
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#channel-defaults-and-heartbeat)  Channel defaults and heartbeat
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#whatsapp)  WhatsApp
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#telegram)  Telegram
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#discord)  Discord
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#google-chat)  Google Chat
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#slack)  Slack
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#mattermost)  Mattermost
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#signal)  Signal
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#bluebubbles)  BlueBubbles
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#imessage)  iMessage
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#microsoft-teams)  Microsoft Teams
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#irc)  IRC
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#multi-account-all-channels)  Multi-account (all channels)
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#other-extension-channels)  Other extension channels
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#group-chat-mention-gating)  Group chat mention gating
...
#### [​](https://docs.openclaw.ai/gateway/configuration-reference\#dm-history-limits)  DM history limits
...
#### [​](https://docs.openclaw.ai/gateway/configuration-reference\#self-chat-mode)  Self-chat mode
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#commands-chat-command-handling)  Commands (chat command handling)
...
## [​](https://docs.openclaw.ai/gateway/configuration-reference\#agent-defaults)  Agent defaults

### [​](https://docs.openclaw.ai/gateway/configuration-reference\#agents-defaults-workspace)  `agents.defaults.workspace`
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#agents-defaults-reporoot)  `agents.defaults.repoRoot`
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#agents-defaults-skipbootstrap)  `agents.defaults.skipBootstrap`
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#agents-defaults-bootstrapmaxchars)  `agents.defaults.bootstrapMaxChars`
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#agents-defaults-bootstraptotalmaxchars)  `agents.defaults.bootstrapTotalMaxChars`
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#agents-defaults-bootstrapprompttruncationwarning)  `agents.defaults.bootstrapPromptTruncationWarning`
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#agents-defaults-imagemaxdimensionpx)  `agents.defaults.imageMaxDimensionPx`
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#agents-defaults-usertimezone)  `agents.defaults.userTimezone`
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#agents-defaults-timeformat)  `agents.defaults.timeFormat`
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#agents-defaults-model)  `agents.defaults.model`
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#agents-defaults-clibackends)  `agents.defaults.cliBackends`
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#agents-defaults-heartbeat)  `agents.defaults.heartbeat`
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#agents-defaults-compaction)  `agents.defaults.compaction`
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#agents-defaults-contextpruning)  `agents.defaults.contextPruning`
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#block-streaming)  Block streaming
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#typing-indicators)  Typing indicators
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#agents-defaults-sandbox)  `agents.defaults.sandbox`
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#agents-list-per-agent-overrides)  `agents.list` (per-agent overrides)
...
## [​](https://docs.openclaw.ai/gateway/configuration-reference\#multi-agent-routing)  Multi-agent routing
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#binding-match-fields)  Binding match fields
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#per-agent-access-profiles)  Per-agent access profiles
...
## [​](https://docs.openclaw.ai/gateway/configuration-reference\#session)  Session
...
## [​](https://docs.openclaw.ai/gateway/configuration-reference\#messages)  Messages
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#response-prefix)  Response prefix
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#ack-reaction)  Ack reaction
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#inbound-debounce)  Inbound debounce
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#tts-text-to-speech)  TTS (text-to-speech)
...
## [​](https://docs.openclaw.ai/gateway/configuration-reference\#talk)  Talk
...
## [​](https://docs.openclaw.ai/gateway/configuration-reference\#tools)  Tools

### [​](https://docs.openclaw.ai/gateway/configuration-reference\#tool-profiles)  Tool profiles
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#tool-groups)  Tool groups
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#tools-allow-/-tools-deny)  `tools.allow` / `tools.deny`
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#tools-byprovider)  `tools.byProvider`
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#tools-elevated)  `tools.elevated`
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#tools-exec)  `tools.exec`
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#tools-loopdetection)  `tools.loopDetection`
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#tools-web)  `tools.web`
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#tools-media)  `tools.media`
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#tools-agenttoagent)  `tools.agentToAgent`
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#tools-sessions)  `tools.sessions`
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#tools-sessions_spawn)  `tools.sessions_spawn`
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#tools-subagents)  `tools.subagents`
...
## [​](https://docs.openclaw.ai/gateway/configuration-reference\#custom-providers-and-base-urls)  Custom providers and base URLs
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#provider-field-details)  Provider field details
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#provider-examples)  Provider examples
...
## [​](https://docs.openclaw.ai/gateway/configuration-reference\#ui)  UI
...
## [​](https://docs.openclaw.ai/gateway/configuration-reference\#gateway)  Gateway
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#openai-compatible-endpoints)  OpenAI-compatible endpoints
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#multi-instance-isolation)  Multi-instance isolation
...
## [​](https://docs.openclaw.ai/gateway/configuration-reference\#hooks)  Hooks
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#gmail-integration)  Gmail integration
...
## [​](https://docs.openclaw.ai/gateway/configuration-reference\#canvas-host)  Canvas host
...
## [​](https://docs.openclaw.ai/gateway/configuration-reference\#discovery)  Discovery

### [​](https://docs.openclaw.ai/gateway/configuration-reference\#mdns-bonjour)  mDNS (Bonjour)
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#wide-area-dns-sd)  Wide-area (DNS-SD)
...
## [​](https://docs.openclaw.ai/gateway/configuration-reference\#environment)  Environment

### [​](https://docs.openclaw.ai/gateway/configuration-reference\#env-inline-env-vars)  `env` (inline env vars)
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#env-var-substitution)  Env var substitution
...
## [​](https://docs.openclaw.ai/gateway/configuration-reference\#secrets)  Secrets

Secret refs are additive: plaintext values still work.

### [​](https://docs.openclaw.ai/gateway/configuration-reference\#secretref)  `SecretRef`
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#supported-credential-surface)  Supported credential surface
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#secret-providers-config)  Secret providers config
...
## [​](https://docs.openclaw.ai/gateway/configuration-reference\#auth-storage)  Auth storage
...
## [​](https://docs.openclaw.ai/gateway/configuration-reference\#logging)  Logging
...
## [​](https://docs.openclaw.ai/gateway/configuration-reference\#cli)  CLI
...
## [​](https://docs.openclaw.ai/gateway/configuration-reference\#wizard)  Wizard
...
## [​](https://docs.openclaw.ai/gateway/configuration-reference\#identity)  Identity
...
## [​](https://docs.openclaw.ai/gateway/configuration-reference\#bridge-legacy-removed)  Bridge (legacy, removed)
...
## [​](https://docs.openclaw.ai/gateway/configuration-reference\#cron)  Cron
...
## [​](https://docs.openclaw.ai/gateway/configuration-reference\#media-model-template-variables)  Media model template variables
...
## [​](https://docs.openclaw.ai/gateway/configuration-reference\#config-includes-$include)  Config includes (`$include`)
