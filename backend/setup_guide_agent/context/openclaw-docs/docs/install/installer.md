...
### Examples (install.sh)
    ...
    | `--version ` | npm version, dist-tag, or package spec (default: `latest`) |
    ...
    | `OPENCLAW_VERSION=latest|next|main||` | npm version, dist-tag, or package spec        |
...
### Examples (install.ps1)
    ...
    | `-Tag ` | npm dist-tag, version, or package spec (default: `latest`) |
